...
# ===============================
# POLLUTANT FULL FORMS (INFO ONLY)
# ===============================
st.markdown("### ℹ️ Pollutant Full Forms & Meaning")
...
Dust, smoke, and larger particles affecting breathing.

**NO₂ (Nitrogen Dioxide)**  
Gas released from vehicles and power plants.

**SO₂ (Sulfur Dioxide)**  
Gas from burning coal and oil in industries.

**CO (Carbon Monoxide)**  
Colorless, odorless, highly poisonous gas from fuel burning.

**O₃ (Ozone – Ground Level)**  
Harmful smog-forming gas that damages lungs.
""")
